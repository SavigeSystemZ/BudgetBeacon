...
- Be aware that other primary adapter files exist for Claude, Codex, Gemini, Windsurf, Cursor, Copilot, DeepSeek, Aider, Continue.dev, Cline, PearAI, and local models.
