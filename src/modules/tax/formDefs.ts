...
export const TAX_FORMS: TaxFormDef[] = [
  ...
  },
  {
    ...
    description: "Rents, royalties, prizes, awards, and other miscellaneous payments.",
    fields: [
      { key: "payerName", label: "Payer name", type: "text", required: true },
      { key: "payerTin", label: "Payer TIN", type: "tin" },
      { key: "rents", label: "Rents (box 1)", type: "currency" },
      { key: "royalties", label: "Royalties (box 2)", type: "currency" },
      { key: "otherIncome", label: "Other income (box 3)", type: "currency" },
      { key: "federalIncomeTaxWithheld", label: "Federal income tax withheld (box 4)", type: "currency" },
      { key: "medicalHealthcarePayments", label: "Medical and healthcare payments (box 6)", type: "currency" },
      { key: "cropInsurance", label: "Crop insurance proceeds (box 9)", type: "currency" },
    ],
  },
  {
    code: "1099-div",
    title: "1099-DIV — Dividends and Distributions",
    description: "Issued by brokerages for dividend income.",
    fields: [
      { key: "payerName", label: "Payer name", type: "text", required: true },
      { key: "payerTin", label: "Payer TIN", type: "tin" },
      { key: "ordinaryDividends", label: "Total ordinary dividends (box 1a)", type: "currency", required: true },
      { key: "qualifiedDividends", label: "Qualified dividends (box 1b)", type: "currency" },
      { key: "capitalGainDistributions", label: "Total capital gain distributions (box 2a)", type: "currency" },
      { key: "section199ADividends", label: "Section 199A dividends (box 5)", type: "currency" },
      { key: "federalIncomeTaxWithheld", label: "Federal income tax withheld (box 4)", type: "currency" },
    ],
  },
  {
    code: "1099-r",
    title: "1099-R — Distributions from Pensions, IRAs, Annuities",
    description: "Issued by retirement-account custodians.",
    fields: [
      { key: "payerName", label: "Payer name", type: "text", required: true },
      { key: "payerTin", label: "Payer TIN", type: "tin" },
      { key: "grossDistribution", label: "Gross distribution (box 1)", type: "currency", required: true },
      { key: "taxableAmount", label: "Taxable amount (box 2a)", type: "currency" },
      { key: "federalIncomeTaxWithheld", label: "Federal income tax withheld (box 4)", type: "currency" },
      { key: "distributionCode", label: "Distribution code (box 7)", type: "text", helper: "e.g. 7 (normal), 1 (early)" },
      { key: "stateTaxWithheld", label: "State tax withheld (box 14)", type: "currency" },
    ],
  },
  {
    code: "1099-g",
    title: "1099-G — Government Payments",
    description: "Unemployment compensation, state tax refunds, and other government payments.",
    fields: [
      { key: "payerName", label: "Payer name", type: "text", required: true },
      { key: "payerTin", label: "Payer TIN", type: "tin" },
      { key: "unemploymentCompensation", label: "Unemployment compensation (box 1)", type: "currency" },
      { key: "stateLocalRefunds", label: "State / local tax refunds (box 2)", type: "currency" },
      { key: "federalIncomeTaxWithheld", label: "Federal income tax withheld (box 4)", type: "currency" },
    ],
  },
  {
