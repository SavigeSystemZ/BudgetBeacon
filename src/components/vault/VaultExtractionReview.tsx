...
function VaultExtractionReviewBody({
  extraction,
  documentId,
  onApprove,
  onClose,
  ...
  const [editedFields, setEditedFields] = useState<ExtractedField[]>(() => [...extraction.fields]);
                    ...
                    {field.confidence !== undefined && (
                      <div className="flex items-center gap-3">
                        ...
                        <input
                          ...
                          onChange={(e) => handleConfidenceChange(idx, parseInt(e.target.value, 10) / 100)}
